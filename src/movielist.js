...
function view (data) {
  return h('div', [
    ...
    h('div', [
      ...
      'Sort by: ',
      h('span.btn-group', [
        h('a.btn.rank', { class: { active: sortBy === 'rank' }, on: { click: () => { return changeSort('rank') } } }, 'Rank'),
        h('a.btn.title', { class: { active: sortBy === 'title' }, on: { click: () => { return changeSort('title') } } }, 'Title'),
        h('a.btn.desc', { class: { active: sortBy === 'desc' }, on: { click: () => { return changeSort('desc') } } }, 'Description'),
      ]),
    ]),
